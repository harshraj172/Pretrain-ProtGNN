...
class DualBranchContrast(torch.nn.Module):
    ...
    def forward(self, h1=None, h2=None, g1=None, g2=None, batch=None, h3=None, h4=None,
        ...
        l1, acc1 = self.loss(anchor=anchor1, sample=sample1, pos_mask=pos_mask1, neg_mask=neg_mask1, topk=topk, **self.kwargs)
        l2, acc2 = self.loss(anchor=anchor2, sample=sample2, pos_mask=pos_mask2, neg_mask=neg_mask2, topk=topk, **self.kwargs)

        return (l1 + l2) * 0.5, (acc1 + acc2) * 0.5
